            ...
            <DialogContent className="sm:max-w-[420px] rounded-2xl p-0 border-surface-border shadow-modal overflow-hidden bg-white animate-in zoom-in-95 duration-default ease-soft">
                <div className="bg-danger-lighter/30 p-8 border-b border-danger-default/10 flex flex-col items-center justify-center">
                    ...
                    <DialogHeader className="text-center">
                        <DialogTitle className="text-xl font-black text-neutral-900 tracking-tight text-center">Delete Role?</DialogTitle>
                        <DialogDescription className="text-neutral-500 font-medium text-center mt-2">
                            This action cannot be undone. You are deleting <span className="font-bold text-neutral-900">{specialization?.name} ({specialization?.level})</span>. This may affect assigned team members.
                        </DialogDescription>
                    </DialogHeader>
                </div>
...
export default DeleteSpecializationModal;
